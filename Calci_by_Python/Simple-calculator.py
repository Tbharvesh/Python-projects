...
root = Tk()
root.title('Calculator by kr492')

i = 0
# Receives digit and display it on input field
...
# Function takes as input and displays it on input field
...
#Function to calculate the factorial and display
def fact():
    entire_string = display.get()
    try:
...
#other buttons to the calculator
